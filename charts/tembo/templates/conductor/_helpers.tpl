...
{{- default .Chart.Name .Values.conductor.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- else }}
{{- $name := default .Chart.Name .Values.conductor.nameOverride }}
...
{{- if .Values.conductor.serviceAccount.create }}
{{- default (include "conductor.fullname" .) .Values.conductor.serviceAccount.name }}
{{- else }}
{{- default "default" .Values.conductor.serviceAccount.name }}
{{- end }}
{{- end }}
